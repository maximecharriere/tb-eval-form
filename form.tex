...
\newcommand{\studentName}{Maxime Charrière}
\newcommand{\studentFieldOfStudy}{EAI}
...
\infosheader{\projectName}{\proffessorName}{\thedate}{\studentName}{\studentFieldOfStudy}{\clientName}
\section*{Évaluation}
\begin{Form}
